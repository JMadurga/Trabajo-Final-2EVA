        ...
        <v-col cols="auto" class="ds d-flex justify-end">
          ...
          <div class="d-flex justify-space-around">
            <v-menu transition="slide-x-reverse-transition">
              ...
              <!--<v-card>
                <v-layout>
                  <v-navigation-drawer v-model="drawer" location="right" temporary full-height width="300">
                    <v-list density="compact" nav>
                      <v-list-item v-for="(item, i) in ticketitem" :key="i">
                        <v-list-item-content>
...
const hamitem = [
  ...
  .bg-image-button { 
    /* Other button styles */ 
    background-image: url('../media/Logoanimacion.svg'); 
